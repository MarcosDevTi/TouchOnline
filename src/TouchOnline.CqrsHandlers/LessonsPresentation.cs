...
namespace TouchOnline.CqrsHandlers
{
    public class LessonsPresentation
    {
            ...
            var exerciciosPt = new HashSet<LessonPresentation>()
                {
                 ...
                 CriarGenercApresent(3, 312, "12", "Geral", 45, "O digite mais é tão fácil! O digite mais é tão fácil! O digite mais é tão fácil! O digite mais é tão fácil! O digite mais é tão fácil! O digite mais é tão fácil! O¶digite mais é tão fácil! O digite mais é tão fácil! O digite mais é tão fácil! O digite mais é tão fácil! O digite mais é tão fácil! O digite mais é tão fácil!"),
        ...
        public HashSet<LessonPresentation> AvancadoApresentacaoPt(bool premium)
        {
            ...
            CriarGenercApresent(4, 402, "02", "Geral", 45, "O Digite Mais vos oferece a possibilidade de criar seus próprios exercícios. Quando houver algum texto que você precise ler para estudar ou decorar, o mais prático é¶inseri-lo no menu ferramentas, em seguida, criar exercício e ele ficará guardado na sua conta para quando quiser voltar a treiná-lo. Dessa forma estará¶ganhando tempo. Lembrando que essa opção só existe para quem se registra e é gratuito."),
